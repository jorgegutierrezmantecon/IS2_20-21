...
import es.unican.is2.practica4.seguros.modelo.Cliente;
import es.unican.is2.practica4.seguros.modelo.Seguro;
import es.unican.is2.practica4.seguros.modelo.Seguro.Cobertura;
import es.unican.is2.practica4.seguros.modelo.Seguro.DatoIncorrectoException;
...
/**
 * Clase que representa a la interfaz de seguros
		...
		btnCalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
			    	...
			    	Seguro seguro = new Seguro(potencia, cobertura, new Cliente("Pepe", "12345678A", minusvalia));
			    	seguro.setFechaUltimoSiniestro(fechaUltimoSiniestro); // anhadimos esta linea para poder modificar la fecha
					...
					txtPrecio.setText("Formato de potencia erróneo");
